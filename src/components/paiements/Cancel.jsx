      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="text-sm text-gray-600 text-center space-y-2">
            <p>Vous pouvez réessayer le paiement ou choisir une autre méthode de paiement.</p>
            <p>Si vous rencontrez des difficultés, notre équipe support est là pour vous aider.</p>
          </div>

          <div className="space-y-2">
            <Button onClick={() => router.push("/caisse")} className="w-full">
              <RefreshCw className="w-4 h-4 mr-2" />
              Réessayer le paiement
            </Button>

            <Button variant="outline" onClick={() => router.push("/mon-compte")} className="w-full">
